...
const DashboardDepan = () => {
  ...
  // const fontFamily1 = Platform.OS === 'android' ? 'Oswald-Bold' : 'Oswald-SemiBold';
...
const styles = StyleSheet.create({
  container1: {
    ...
    percentageText: {
      fontSize: RFPercentage(3), // 3% of total screen size
    },
    valueText: {
      fontSize: RFValue(20), // 20 units based on screen height
    },
  }
});
